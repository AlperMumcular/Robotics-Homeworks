...
def pygame_image_load(tilepath):
	return pygame.image.load( "/home/alper/Robotics-Homeworks/gym-examples/gym_examples/envs/" + tilepath).convert_alpha()
	
def convert_tuples_to_dict(list_of_tuples):
    return {tuple[0] : tuple[1:] for tuple in list_of_tuples}
	
def list_tiles(folder):
    return listdir("/home/alper/Robotics-Homeworks/gym-examples/gym_examples/envs/" + folder)
